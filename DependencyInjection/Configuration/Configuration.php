...
namespace Octante\MarvelAPIBundle\DependencyInjection\Configuration;
            ...
            ->children()
                ->arrayNode('class')
                    ...
                    ->children()
                        ...
                        ->scalarNode('connection_wrapper')->defaultValue('Octante\MarvelAPIBundle\Client\Predis\Connection\ConnectionWrapper')->end()
                        ->scalarNode('phpredis_client')->defaultValue('Redis')->end()
                        ->scalarNode('phpredis_base_connection_wrapper')
                            ->defaultValue('Octante\MarvelAPIBundle\Client\Phpredis\BaseClient')
                        ->end()
                        ->scalarNode('phpredis_connection_wrapper')->defaultValue('Octante\MarvelAPIBundle\Client\Phpredis\Client')->end()
                        ->scalarNode('logger')->defaultValue('Octante\MarvelAPIBundle\Logger\RedisLogger')->end()
                        ->scalarNode('data_collector')->defaultValue('Octante\MarvelAPIBundle\DataCollector\RedisDataCollector')->end()
                        ->scalarNode('doctrine_cache')->defaultValue('Octante\MarvelAPIBundle\Doctrine\Cache\RedisCache')->end()
                        ->scalarNode('monolog_handler')->defaultValue('Monolog\Handler\RedisHandler')->end()
                        ->scalarNode('swiftmailer_spool')->defaultValue('Octante\MarvelAPIBundle\SwiftMailer\RedisSpool')->end()
                    ->end()
                ->end()
            ->end();
